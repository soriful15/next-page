...
import reader from "../../assets/animation/94115-reading-boy.json";
...
const Home = () => {
    return (
        <>
          ...
          <div className='my-container flex flex-col items-center justify-between lg:flex-row mx-auto container'>
      {/* Text Content */}
