    ...
    return (
      ...
      <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto'>
        ...
        {fold ? (
            ...
            <span onClick={()=>setFold(!fold)} className='cursor-pointer text-blue-600'>Read more</span>
            ...
            <span onClick={()=>setFold(!fold)} className='cursor-pointer text-blue-600'>Read less</span>
            </>
        ) }
         {/*  {fold ? (
            <>
